...
class LinearBn(nn.Module):
    def __init__(self, in_channel, out_channel, act=None):
        ...
        self.bn = nn.BatchNorm1d(out_channel, eps=1e-08, momentum=0.1)
        self.act = act
...
class Fingerprint(torch.nn.Module):
    def __init__(self, num_target, fingerprint_dim, K=3, T=3, p_dropout=0.2, atom_dim=55, bond_dim=10):
